@include('layouts.listings-header');
          ...
          <div class="single_page_heading_content">
            <div class="car_single_content_wrapper">
              <ul class="car_info mb20-md">
                <li class="list-inline-item"><a href="#">{{$cars->type}}</a></li>
                <li class="list-inline-item"><a href="#"><span class="flaticon-clock-1 vam"></span>2 years ago</a></li>
                <li class="list-inline-item"><a href="#"><span class="flaticon-eye vam"></span>13102</a></li>
              </ul>
              <h2 class="title">{{$cars->listing_title}}</h2> 
          ...
          <div class="row">
                        ...
                        <div class="single_product">
                          <div class="single_item">
                            <div class="thumb">
                              ...
                              <img class="img-fluid" src="{{ asset($cars->image)}}" alt="lsp1-v1.jpg">
                            </div>
                          </div>
                      ...
                      <div class="thumb">
                        <div class="single_product">
                          <div class="single_item">
                            <div class="thumb">
                              <div class="tags">FEATURED</div>
                              <img class="img-fluid" src="{{asset('images/listing/lsp1-v2.jpg')}}" alt="lsp1-v2.jpg">
                            </div>
                          </div>
                          <div class="overlay_icon"><a class="video_popup_btn popup-img popup-youtube" href="https://www.youtube.com/watch?v=oqNZOOWF8qM"><span class="flaticon-play-button"></span>Video</a></div>
                        </div>
                      ...
                      <div class="thumb">
                        <div class="single_product">
                          <div class="single_item">
                            <div class="thumb">
                              <div class="tags">FEATURED</div>
                              <img class="img-fluid" src="{{asset('images/listing/lsp1-v3.jpg')}}" alt="lsp1-v3.jpg">
                            </div>
                          </div>
                          <div class="overlay_icon"><a class="video_popup_btn popup-img popup-youtube" href="https://www.youtube.com/watch?v=oqNZOOWF8qM"><span class="flaticon-play-button"></span>Video</a></div>
                        </div>
                      ...
                      <div class="thumb">
                        <div class="single_product">
                          <div class="single_item">
                            <div class="thumb">
                              <div class="tags">FEATURED</div>
                              <img class="img-fluid" src="{{asset('images/listing/lsp1-v4.jpg')}}" alt="lsp1-v4.jpg">
                            </div>
                          </div>
                          <div class="overlay_icon"><a class="video_popup_btn popup-img popup-youtube" href="https://www.youtube.com/watch?v=oqNZOOWF8qM"><span class="flaticon-play-button"></span>Video</a></div>
                        </div>
                      ...
                      <div class="thumb">
                        <div class="single_product">
                          <div class="single_item">
                            <div class="thumb">
                              <div class="tags">FEATURED</div>
                              <img class="img-fluid" src="{{asset('images/listing/lsp1-v5.jpg')}}" alt="lsp1-v5.jpg">
                            </div>
                          </div>
                          <div class="overlay_icon"><a class="video_popup_btn popup-img popup-youtube" href="https://www.youtube.com/watch?v=oqNZOOWF8qM"><span class="flaticon-play-button"></span>Video</a></div>
                        </div>
                ...
                <div class="wrapper">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      ...
                      <span class="schedule">{{$cars->make}}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      <div class="me-auto">
                        <div class="day">Model</div>
                      </div>
                      <span class="schedule">{{$cars->model}}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      <div class="me-auto">
                        <div class="day">Color</div>
                      </div>
                      <span class="schedule">{{$cars->color}}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      <div class="me-auto">
                        <div class="day">Drive Type</div>
                      </div>
                      <span class="schedule">{{$cars->drive_type}}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      <div class="me-auto">
                        <div class="day">Transmission</div>
                      </div>
                      <span class="schedule">{{$cars->transmission}}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      <div class="me-auto">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      ...
                      <span class="schedule">{{$cars->mileage}}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      <div class="me-auto">
                        <div class="day">Fuel Type</div>
                      </div>
                      <span class="schedule">{{$cars->fuel_type}}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      <div class="me-auto">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      ...
                      <span class="schedule">{{$cars->seats}}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      <div class="me-auto">
            ...
            <div class="col-lg-12">
              <div class="listing_single_description mt30">
                ...
                <p class="first-para">{{$cars->description}}</p>
              </div>
            </div>
            <div class="col-lg-12">
                  ...
                  <div class="mbp_pagination_comments">
                    <div class="mbp_first d-flex db-414">
                      <div class="flex-shrink-0">
                        <img src="{{asset('images/blog/reviewer1.png')}}" class="mr-3" alt="reviewer1.png">
                      </div>
                    ...
                    <div class="mbp_first d-flex db-414">
                      <div class="flex-shrink-0">
                        <img src="{{asset('images/blog/reviewer2.png')}}" class="mr-3" alt="reviewer2.png">
                      </div>
                      <div class="flex-grow-1 ms-4 ml0-414">
                        <h4 class="sub_title">Jane Cooper</h4>
                        <div class="sspd_postdate mb15">April 6, 2021 at 3:21 AM
            ...
            <div class="col-lg-12">
              <div class="user_review_form">
                <div class="bsp_reveiw_wrt">
                  ...
                  <form  class="comments_form" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-md-6">
        ...
        <div class="col-lg-4 col-xl-4">
          ...
          <div class="sidebar_seller_contact">
            <div class="d-flex align-items-center mb30">
              <div class="flex-shrink-0">
                <img class="mr-3 author_img w60" src="{{asset('images/team/seller.png')}}" alt="author.png">
              </div>
              <div class="flex-grow-1 ms-3">
                <h5 class="mt0 mb5 fz16 heading-color fw600">Yatra Cars</h5>
                <p class="mb0 tdu"><span class="flaticon-phone-call pr5 vam"></span>Call Us: 098198 49131</p>
              </div>
            </div>
            <h4 class="mb30">Contact Seller</h4>
           

<form action="{{route('book.car')}}" method="POST" onsubmit="return validation()" enctype="multipart/form-data">
              @csrf
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="GSTno"  value="{{ old('name')}}" class="form-control">
                    <span class="text-danger">
                      @error('GSTno')
                      {{$message}}
                      @enderror
                ...
                <div class="col-lg-6">
                  <div class="form-group mb20">
                    ...
                    <input type="date" name="booking_till"   class="form-control">
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-md-4 col-xl-7">
          <div class="footer_about_widget text-start">
            <div class="logo mb40 mb0-sm"><img src="{{asset('images/header-logo.svg')}}" alt="header-logo.png"></div>
          </div>
        </div>
...
<!-- Mirrored from creativelayers.net/themes/voiture-html/page-car-single-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Sep 2023 11:44:19 GMT -->
</html>
