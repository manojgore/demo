        ...
        <div class="col-lg-4 col-xl-5">
          <div class="header_top_social_widgets text-center text-md-end">
            <ul class="m0">
              ...
              <li class="list-inline-item"><a href="{{route('showcompany.login')}}" data-bs-toggle="modal" data-bs-target="#logInModal">Login</a></li>
              <li class="list-inline-item"><a href="{{route('showcompany.signup')}}" data-bs-toggle="modal" data-bs-target="#logInModal">Register</a></li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <ul>
              <li> <a href="#">Listing Styles</a> 
                ...
                <li><a href="{{route('listingv1')}}">Lising V1</a></li>
                  <li><a href="{{route('listingv1')}}">Listing v2</a></li>
                  <li><a href="{{route('listingv1')}}">Listing v3</a></li>
                </ul>
              </li>
              ...
              <li> <a href="#">Listing Single</a> 
                <ul>
                  <li><a href="{{route('listingv1')}}">Single V1</a></li>
                  <li><a href="{{route('listingv1')}}">Single V2</a></li>
                </ul>
              </li>
              <li><a href="page-dashboard-add-listings.html">New Listing</a></li>
            </ul>
          </li>
          <li class="add_listing"><a href="{{route ('login.company')}}">Login</a></li>
          <li class="add_listing"><a href="{{route('showcompany.signup')}}">Register</a></li>
        </ul>
      </div>
    </nav>
  </header>
          ...
          <div class="row">
            <div class="col-lg-12">
              <ul class="sign_up_tab nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="{{route ('showcompany.login')}}" role="tab" aria-controls="home" aria-selected="true">Login</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="{{route('showcompany.signup')}}" role="tab" aria-controls="profile" aria-selected="false">Register</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="row mt30 tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
              <div class="col-lg-12">
                <div class="sign_up_form">
                  <p>Already have a profile? <a href="{{route('showcompany.login')}}">Sign in.</a></p>
                  <form action="#">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb20">
  ...
  <div id="page" class="stylehome1 h0">
    ...
    <nav id="menu" class="stylehome1">
      <ul>
        ...
        <li class="add_listing"><a href="{{route ('showcompany.login')}}">Login</a></li>
                ...
                <div class="col-lg-12">
                  <div class="extra-dashboard-menu dn-lg">
                    <div class="ed_menu_list">
                        <ul> 
                            <li><a href="{{route('companies.dashboard')}}"><span class="flaticon-dashboard"></span>Dashboard</a></li>
                            <li> <a href="{{ route('companies.profile')}}"><span class="flaticon-user-2"></span>Profile</a></li>
                                 <li><a href="{{route('companies.orders')}}"><span class="flaticon-list"></span>My Orders</a></li>
