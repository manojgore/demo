              ...
              <li> <a href="#">User Info</a> 
                <ul> 
                  <li><a href="{{route('admin.dashboard')}}"><span class="flaticon-dashboard"></span>Dashboard</a></li>
                    ...
                    <li><a href="{{route('admin.customers')}}"><span class="flaticon-list"></span>Customers</a></li>
                    <li><a href="#"><span class="flaticon-heart"></span>Favorites</a></li>
                    <li><a href="{{route('admin.companies')}}"><span class="flaticon-heart"></span>Companies</a></li>
                    <li><a href="{{route('admin.addlisting')}}"><span class="flaticon-plus"></span>Add Listing</a></li>
                    <li><a href="{{route('admin.messages')}}"><span class="flaticon-message"></span>Messags</a></li>
          ...
          <li class="user_setting">
            <div class="dropdown">
              <a class="btn dropdown-toggle" href="#" data-bs-toggle="dropdown">
                <img class="rounded-circle mr10" src="{{ asset('images/team/e1.png') }}" alt="e1.png"> 
                <span class="dn-1366"> Admin <span class="fas fa-angle-down ml5"></span></span>
              </a>
              <div class="dropdown-menu">
                <div class="user_set_header">
                  <img class="float-start" src="{{asset('images/team/e1.png')}}"  alt="e1.png">
                  <p>Jerome Bell <br><span class="address">alitufan@gmail.com</span></p>
                </div>
                <div class="user_setting_content">
                  <a class="dropdown-item active" href="#">My Profile</a>
                  <a class="dropdown-item" href="{{route('admin.carslistings')}}">Messages</a>
                  <a class="dropdown-item" href="{{route('admin.carslistings')}}">My Listing</a>
                  <a class="{{route('LogOut')}}" href="#">Log out</a>
                </div>
              </div>
            </div>
          </li>
