                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="nav nav-tabs justify-content-start" role="tablist">
                      <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Scheduled Orders</button>
                      <button class="nav-link" id="nav-shopping-tab" data-bs-toggle="tab" data-bs-target="#nav-shopping" role="tab" aria-controls="nav-shopping" aria-selected="true">Completed Orders</button>
                      <button class="nav-link" id="nav-hotels-tab" data-bs-toggle="tab" data-bs-target="#nav-hotels" role="tab" aria-controls="nav-hotels" aria-selected="true">Cancelled Orders</button>
                    </div>
                  </div>
                  <!-- Tab panes -->
                                ...
                                <table class="table de-table">
                                  <thead>
                                    <tr>
                                      ...
                                      <th scope="col"><span class="text-uppercase fs-12 text-gray">GST No:</span></th>
                                      <th scope="col"><span class="text-uppercase fs-12 text-gray">Booking from:</span></th>
                                      <th scope="col"><span class="text-uppercase fs-12 text-gray">Booking till: </span></th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td> {{ $booking->booking_till }}</td>
                                      <td><div class="badge rounded-pill bg-success"> pending</div></td>
                                    </tr>
                                    @endforeach
                                  </tbody>
                                </table>
